...
def MilkerBaker(page):
    ...
    page.textLine("The milkman and the baker first meet on the 1st January.")
    ...
    page.textLine("Q2. How many times do they meet this year? (Including the 1st January.)")
...
qns.textLine("[QUESTION 1: Sequences ]")
qns.textLine("What are the missing numbers in the following sequences: ")
qns.textLine("")

qns.textLine(', '.join(setqn(seq1(10),0)))
qns.textLine("")

qns.textLine(', '.join(setqn(seq2(10),0)))
qns.textLine("")

qns.textLine(', '.join(setqn(seq3(6),1)))
qns.textLine("")
qns.textLine("")

qns.textLine("[QUESTION 2: Time ]")

q1, q2 = beatsPerMinute()
qns.textLine(q1)
qns.textLine(q2)
qns.textLine("")
...
qns.textLine("[QUESTION 3: CRICKET AND STATISTICS. ]")
q1,q2,q3,q4 = cricket()
qns.textLine(q1)
qns.textLine("")
...
qns.textLine("[QUESTION 4: LOWEST COMMON MULTIPLES ]")
q1, q2,q3 = lcmtest()
qns.textLine(q1)
qns.textLine(q2)
qns.textLine(q3)
...
qns.textLine("[QUESTION 5: LOWEST COMMON MULTIPLES ]")
MilkerBaker(qns)
